...
// or a corner. This is the rule the printed puzzle uses, and it cuts the
// standard instance from 15,046,987,768 configurations to a far smaller number.
//
// WHY THE STANDARD PROFILE IS NOT ENOUGH
//
// Sweeping column-major, the decided 8-neighbours of cell (r,c) are
//
